...
- View total items and total price in real time  
- Switch between *Product List* and *Cart* views  
- Built with modern tools: **Vite**, **TypeScript**, and **React 18**
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/yourusername/lesson17.git
   cd lesson17
